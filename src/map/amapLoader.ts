...
export function loadAmap(): Promise<AMapNamespace> {
  ...
  pendingLoad = new Promise<AMapNamespace>((resolve, reject) => {
    ...
    script.src = `https://webapi.amap.com/maps?v=2.0&key=${encodeURIComponent(key)}&plugin=AMap.Driving,AMap.PlaceSearch,AMap.ToolBar,AMap.Scale,AMap.Weather&callback=__yiliAmapReady`;
