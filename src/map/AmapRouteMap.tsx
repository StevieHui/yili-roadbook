  ...
  return (
    <section className="map-section" id="map" aria-labelledby="map-title">
      <div className="map-copy">
        <p className="section-kicker">1,198 KM / 7 SEGMENTS</p>
        <h2 id="map-title">路线不是一条线，<br />是七种风景的次序</h2>
        <p>选择日历日期，高亮当天真实道路轨迹与停靠点。山区路线以现场交通管制和高德实时导航为准。</p>
      ...
      <div className="map-frame">
        ...
        {loading && !error && <div className="map-status">正在绘制真实道路…</div>}
        {error && (
          <div className="map-fallback" role="status">
            <strong>地图暂时无法加载</strong>
            <p>{error}。正文路书仍可正常使用。</p>
            <ol>
