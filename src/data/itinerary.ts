...
const stops = {
  ...
  yuanjuge: { id: 'yuanjuge', name: '缘居阁民宿', coordinates: [81.256002, 43.94894], kind: 'stay' },
...
export const tripDays: readonly TripDay[] = [
  {
    ...
    route: [stops.yuanjuge, stops.sayramEast, stops.sayramMoon, stops.sayramSouth, stops.guozigou, stops.yuanjuge],
    timeline: [
      { time: '08:00', activity: '缘居阁出发', detail: '加满油，早餐后从天津北路 148 号出发，经 G30 连霍高速前往赛里木湖，途经果子沟。' },
      ...
      { time: '19:30', activity: '返回缘居阁', detail: '天黑前回到天津北路 148 号缘居阁民宿；如体力允许，可先去六星街晚餐散步。' },
    ],
  ...
  },
  {
    ...
    route: [stops.yuanjuge, stops.baishifeng, stops.angellet, stops.zhaosu, stops.changqiaojun],
    timeline: [
      { time: '08:00', activity: '缘居阁出发', detail: '从天津北路 148 号出发前加满油（伊昭公路全程无加油站），沿 S237 省道驶入伊昭公路。' },
      ...
      { time: '15:00', activity: '入住长桥郡', detail: '抵达特克斯后前往长桥郡入住，下午可在城区散步、登城中心看放射状街道全景。' },
    ],
  ...
  },
  {
    ...
    route: [stops.changqiaojun, stops.kalajun, stops.changqiaojun],
    timeline: [
      { time: '09:00', activity: '长桥郡出发', detail: '睡足后从长桥郡从容出发，车程仅半小时。连住两晚不用搬行李。' },
      ...
      { time: '20:00', activity: '返回长桥郡', detail: '傍晚返回长桥郡，可先在八卦城登高处看日落时分的放射状城市街道。' },
    ],
  ...
  },
  {
    ...
    route: [stops.changqiaojun, stops.kuerdening],
    timeline: [
      { time: '09:00', activity: '长桥郡出发', detail: '退房后从长桥郡出发，走河谷道路前往巩留。' },
  ...
  },
  {
    ...
    highlights: ['独库北段', '高山垭口', '乔尔玛路口', '唐布拉百里画廊'],
    photoSpots: [
  ...
  },
  {
    ...
    timeline: [
      ...
      { time: '15:30', activity: '完成还车', detail: '机场服务点办结交车后前往天津北路 148 号缘居阁民宿入住，次日按早班机节奏出发。' },
    ],
